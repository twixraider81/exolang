...
namespace exo
{
	...
	{
		const char* UnknownVar::what()
		{
			if( const std::string *variableName = boost::get_error_info<exo::exceptions::VariableName>( *this ) ) {
				msg.append( "Unknown variable $" ).append( *variableName );
